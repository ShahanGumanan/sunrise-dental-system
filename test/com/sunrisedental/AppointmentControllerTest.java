...
public class AppointmentControllerTest {
    @Test
    public void rejectsIncompleteAppointmentsWithoutCallingDao() {
    ...
    @Test
    public void rejectsAppointmentsInThePast() {
        AppointmentDAO dao = mock(AppointmentDAO.class);
        AppointmentController controller = new AppointmentController(dao);
    ...
    @Test
    public void rejectsPastTimeOnToday() {
        AppointmentDAO dao = mock(AppointmentDAO.class);
        AppointmentController controller = new AppointmentController(dao);
        Appointment appointment = validAppointment();
    ...
    @Test
    public void rejectsBlankAppointmentNumber() {
        AppointmentDAO dao = mock(AppointmentDAO.class);
        AppointmentController controller = new AppointmentController(dao);
        Appointment appointment = validAppointment();
    ...
    @Test
    public void acceptsFutureAppointmentAndDelegatesToDao() {
        AppointmentDAO dao = mock(AppointmentDAO.class);
